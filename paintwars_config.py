...
# Red team
import paintwars_braitenberg_loveEnemy  # importer votre code

get_name_red_team = paintwars_braitenberg_loveEnemy.get_team_name  # mettre ici votre fonction get_team_name
step_red_team = paintwars_braitenberg_loveEnemy.step  # mettre ici votre fonction step
