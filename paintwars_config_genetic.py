...
# Red team
import paintwars_genetic_algorithm  # importer votre code

get_name_red_team = paintwars_genetic_algorithm.get_team_name  # mettre ici votre fonction get_team_name
step_red_team = paintwars_genetic_algorithm.step  # mettre ici votre fonction step
